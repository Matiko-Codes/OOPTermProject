...
public class Delete_Customer extends JFrame implements ActionListener {
    ...
    Delete_Customer() {
        ...
        Image img = ic.getImage().getScaledInstance(400, 500, Image.SCALE_DEFAULT);
            ...
            public void mouseClicked(MouseEvent arg0) {
                try {
                    ...
                    while (rest1.next()) {
                        ...
                        tf9.setText(rest1.getString("idnumber"));
                    }
                } catch (Exception exx) 
                {
                    exx.printStackTrace();
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==bt1)
        {
            ...
            try
            {
                ...
                String q1="delete from nairobimathree where username='"+username+"'";
                int aa=obj3.stm.executeUpdate(q1);
                if(aa==1)
                {
                    JOptionPane.showMessageDialog(null,"your data has been successfully deleted");
