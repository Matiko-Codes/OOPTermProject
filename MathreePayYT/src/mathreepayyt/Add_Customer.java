...
public class Add_Customer extends JFrame implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e) 
    {
        if(e.getSource()==b)
        {
            ...
            String idnumber=t10.getText();
            
            try
            {
                ConnectionClass obj=new ConnectionClass();
                String q ="insert into customer values('"+username+"','"+name+"','"+age+"','"+dateofbirth+"','"+address+"','"+phone+"','"+email+"','"+country+"','"+gender+"','"+idnumber+"')";
