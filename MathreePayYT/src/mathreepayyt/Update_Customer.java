...
public class Update_Customer extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==bt1)
        {
            ...
            String idnumber=tf9.getText();
            
            try
            {
                ConnectionClass obj3=new ConnectionClass();
                String q1="update customer set name='"+name+"','"+age+"','"+dateofbirth+"','"+address+"','"+phone+"','"+email+"','"+country+"','"+gender+"','"+idnumber+"' where username='"+username+"'";
